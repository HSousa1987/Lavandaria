...
\restrict lA47vUPigj4DSuhQ8MLlZUfoZTBVGELmEJBgfmWNoIjUn3CAoJlAC0tfUlBVChu
...
COPY public.cleaning_jobs (id, client_id, assigned_worker_id, job_type, property_name, property_address, address_line1, address_line2, city, postal_code, district, country, scheduled_date, scheduled_time, estimated_hours, actual_start_time, actual_end_time, total_duration_minutes, hourly_rate, total_cost, status, payment_status, payment_method, paid_amount, notes, special_instructions, client_feedback, client_rating, created_by, created_at, updated_at, completed_at, push_notification_sent, client_viewed_photos, last_synced_at) FROM stdin;
1	1	\N	airbnb	\N	Apartment 12B, Rua das Flores	Rua das Flores, 123	\N	Lisboa	\N	\N	Portugal	2025-11-11	10:00:00	\N	\N	\N	\N	15.00	\N	scheduled	pending	\N	0.00	\N	\N	\N	\N	1	2025-11-09 10:51:00.406956	2025-11-09 10:51:00.406956	\N	f	f	\N
2	1	3	airbnb	Test Apartment	Test Apartment, Avenida da Liberdade, 100	Avenida da Liberdade, 100	\N	Lisboa	1200-001	Lisboa	Portugal	2025-11-10	10:00:00	2.00	\N	\N	\N	15.00	\N	scheduled	pending	\N	0.00	\N	\N	\N	\N	2	2025-11-09 11:05:54.823438	2025-11-09 11:05:54.823438	\N	f	f	\N
\.
...
COPY public.clients (id, phone, password, full_name, first_name, last_name, email, date_of_birth, nif, address_line1, address_line2, city, postal_code, district, country, notes, is_enterprise, company_name, registration_date, created_at, is_active, must_change_password) FROM stdin;
1	911111111	$2b$10$XYjLzqW8K9H.eN6D9h3.8OZN.q7K6r3zv3fV3d7N.H8K9XYjLzqW8K	João Santos	João	Santos	joao@example.com	\N	\N	\N	\N	\N	\N	\N	Portugal	Sample client for testing	f	\N	2025-11-09 10:51:00.403183	2025-11-09 10:51:00.403183	t	t
\.
...
--
-- Data for Name: payments_cleaning; Type: TABLE DATA; Schema: public; Owner: lavandaria
--

COPY public.payments_cleaning (id, cleaning_job_id, client_id, amount, payment_method, payment_date, notes, created_at) FROM stdin;
\.


--
-- Data for Name: payments_laundry; Type: TABLE DATA; Schema: public; Owner: lavandaria
--

COPY public.payments_laundry (id, laundry_order_id, client_id, amount, payment_method, payment_date, notes, created_at) FROM stdin;
\.
...
COPY public.properties (id, client_id, name, address_line1, address_line2, city, postal_code, district, country, property_type, access_instructions, is_primary, created_at) FROM stdin;
\.
...
FNczFaCaOvLSF7UAlEKjErKkbM3w_qPK	{"cookie":{"originalMaxAge":2592000000,"expires":"2025-12-09T11:06:17.170Z","secure":false,"httpOnly":true,"path":"/","sameSite":"lax"},"userId":1,"userType":"master","userName":"Master Admin"}	2025-12-09 12:35:28
...
COPY public.tickets (id, title, description, order_type, order_id, priority, status, created_by, assigned_to, resolved_at, resolved_by, notes, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (id, username, password, role, full_name, first_name, last_name, email, phone, date_of_birth, nif, address_line1, address_line2, city, postal_code, district, country, created_at, updated_at, registration_date, is_active, created_by) FROM stdin;
1	master	$2b$10$iyoWMyQRwUrseBPEUOvu6.9xMRJ4d6RCjIbfv/OpollcbeMQWiU.e	master	Master Admin	Master	Admin	master@lavandaria.com	\N	\N	\N	\N	\N	\N	\N	\N	Portugal	2025-11-09 10:51:00.400198	2025-11-09 10:51:00.400198	2025-11-09 10:51:00.400198	t	\N
2	admin	$2b$10$AC7dVLo.KeW3YgIeveZ9C.Dy/qmDxQhoDtvf0Q2vW2k/EZyy8uNEy	admin	Administrator	Administrator		admin@lavandaria.com	\N	\N	\N	\N	\N	\N	\N	\N	Portugal	2025-11-09 10:51:00.400198	2025-11-09 10:51:00.401731	2025-11-09 10:51:00.400198	t	1
3	worker1	$2b$10$5TBBvMz.csBeXlp/isBgnuMi8xlMGywuot8VUxN5QaP5Qz7ELYZJW	worker	Maria Silva	Maria	Silva	\N	\N	\N	\N	\N	\N	\N	\N	\N	Portugal	2025-11-09 10:51:00.400198	2025-11-09 10:51:00.401731	2025-11-09 10:51:00.400198	t	1
\.
...
--
-- Name: payments_cleaning_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lavandaria
--

SELECT pg_catalog.setval('public.payments_cleaning_id_seq', 1, false);


--
-- Name: payments_laundry_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lavandaria
--

SELECT pg_catalog.setval('public.payments_laundry_id_seq', 1, false);
...
\unrestrict lA47vUPigj4DSuhQ8MLlZUfoZTBVGELmEJBgfmWNoIjUn3CAoJlAC0tfUlBVChu
